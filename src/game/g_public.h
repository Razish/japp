...
typedef enum {
	...
	G_TRACE,	// ( trace_t *results, const vector3 *start, const vector3 *mins, const vector3 *maxs, const vector3 *end, int passEntityNum, int contentmask );
	// collision detection against all linked entities

	G_G2TRACE,	// ( trace_t *results, const vector3 *start, const vector3 *mins, const vector3 *maxs, const vector3 *end, int passEntityNum, int contentmask );
	// collision detection against all linked entities with ghoul2 check

	G_POINT_CONTENTS,	// ( const vector3 *point, int passEntityNum );
	// point contents against all linked entities

	G_IN_PVS,			// ( const vector3 *p1, const vector3 *p2 );

	G_IN_PVS_IGNORE_PORTALS,	// ( const vector3 *p1, const vector3 *p2 );
	...
	G_ENTITIES_IN_BOX,	// ( const vector3 *mins, const vector3 *maxs, gentity_t **list, int maxcount );
	// EntitiesInBox will return brush models based on their bounding box,
	// so exact determination must still be done with EntityContact

	G_ENTITY_CONTACT,	// ( const vector3 *mins, const vector3 *maxs, const gentity_t *ent );
	...
	G_TRACECAPSULE,	// ( trace_t *results, const vector3 *start, const vector3 *mins, const vector3 *maxs, const vector3 *end, int passEntityNum, int contentmask );
	G_ENTITY_CONTACTCAPSULE,	// ( const vector3 *mins, const vector3 *maxs, const gentity_t *ent );
