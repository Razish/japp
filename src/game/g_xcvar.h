...
XCVAR_DEF( g_privateDuel,					"1",					CVU_Duel,		CVAR_ARCHIVE,									qtrue )
...
XCVAR_DEF( japp_showHeartbeats,				"0",					NULL,			CVAR_NONE,										qfalse )
...
XCVAR_DEF( japp_voteDisable,				"0",					NULL,			CVAR_NONE,										qtrue )
