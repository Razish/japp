...
XCVAR_DEF( cg_chatboxPos,						"128 395",							CVU_ChatboxPos,			CVAR_ARCHIVE )
XCVAR_DEF( cg_chatboxSize,						"0.5 497",							CVU_ChatboxSize,		CVAR_ARCHIVE )
XCVAR_DEF( cg_chatboxBackground,				"0.0 0.0 0.0 0.5",					CVU_ChatboxBG,			CVAR_ARCHIVE )
XCVAR_DEF( cg_chatboxCompletion,				"1",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_chatboxFont,						"6",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_chatboxHeight,					"350",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_chatboxLineHeight,				"10",								NULL,					CVAR_ARCHIVE )
...
XCVAR_DEF( cg_consolePromptChar,				"]",								CVU_ConsoleChar,		CVAR_ARCHIVE )
...
XCVAR_DEF( cg_hudLagometerPos,					"48 160",							CVU_LagPos,				CVAR_ARCHIVE )
XCVAR_DEF( cg_hudMovementKeys,					"0",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_hudMovementKeysPos,				"320 240",							CVU_MoveKeysPos,		CVAR_ARCHIVE )
XCVAR_DEF( cg_hudMovementKeysScale,				"1.0",								NULL,					CVAR_ARCHIVE )
...
XCVAR_DEF( cg_logChat,							"chat.cl.log",						NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_logConsole,						"console.cl.log",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_logSecurity,						"security.cl.log",					NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_marks,							"1",								NULL,					CVAR_ARCHIVE )
#ifdef JAPP_MINISCOREBOARD
XCVAR_DEF( cg_miniScoreboard,					"5",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_miniScoreboardX1,					"400",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_miniScoreboardX2,					"570",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_miniScoreboardY,					"8",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_miniScoreboardS,					"0.375",							NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_miniScoreboardA,					"0.5",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_miniScoreboardW,					"245",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( cg_miniScoreboardLH,					"12",								NULL,					CVAR_ARCHIVE )
#endif
XCVAR_DEF( cg_newChatbox,						"1",								NULL,					CVAR_ARCHIVE )
...
XCVAR_DEF( cg_saberBladeStyle,					"1",								NULL,					CVAR_ARCHIVE )
...
XCVAR_DEF( cg_teamSabersRGB,					"1",								NULL,					CVAR_ARCHIVE )
...
XCVAR_DEF( r_postprocess_bloom,					"1",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_bloomBlurStyle,		"1",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_bloomMulti,			"1",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_bloomSat,				"1",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_bloomSceneMulti,		"1",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_bloomSceneSat,			"1",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_bloomSize,				"512",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_bloomSteps,			"2",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_brightPassThres,		"0.5",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_brightPassStyle,		"3",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_debugFBOs,				"0",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_enable,				"0",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_hdr,					"0",								NULL,					CVAR_ARCHIVE )
XCVAR_DEF( r_postprocess_hdrExposureBias,		"0.18",								NULL,					CVAR_ARCHIVE )
