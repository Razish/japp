...
typedef enum //# setType_e
{
    ...
    SET_ICARUS_FREEZE,   //## %s="NULL" # Specify name of entity to freeze - !!!NOTE!!! since the ent is frozen, it cannot unfreeze itself, you must have some
                         //other entity unfreeze a frozen ent!!!
    SET_ICARUS_UNFREEZE, //## %s="NULL" # Specify name of entity to unfreeze - !!!NOTE!!! since the ent is frozen, it cannot unfreeze itself, you must have some
                         //other entity unfreeze a frozen ent!!!
    ...
    SET_ADJUST_AREA_PORTALS, //## %t="BOOL_TYPES" # Only set this on things you move with script commands that you *want* to open/close area portals.  Default
                             //is off.
