...
void G_CheckMinimumPlayers(void) {
    ...
    //	then addbot
    if ((humanplayers + botplayers) < bot_minplayers.integer && (!bot_maxbots.integer || (humanplayers + botplayers) < bot_maxbots.integer)) {
        G_AddRandomBot(-1);
