...
static qboolean SE_RenderIsVisible( const gentity_t *self, const vector3 *startPos, const vector3 *testOrigin,
...
static qboolean SE_RenderPlayerPoints( qboolean isCrouching, const vector3 *playerAngles, const vector3 *playerOrigin,
	vector3 playerPoints[9] )
{
