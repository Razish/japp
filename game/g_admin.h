...
#define PRIV_BYPASSFLOOD	(0x00000001u)
#define PRIV_WHOIS			(0x00000002u)
#define PRIV_STATUS			(0x00000004u)
#define PRIV_ANNOUNCE		(0x00000008u)
#define PRIV_GHOST			(0x00000010u)
#define PRIV_CLIP			(0x00000020u)
#define PRIV_TELEPORT		(0x00000040u)
#define PRIV_POLL			(0x00000080u)
#define PRIV_KILLVOTE		(0x00000100u)
#define PRIV_FORCETEAM		(0x00000200u)
#define PRIV_PROTECT		(0x00000400u)
#define PRIV_EMPOWER		(0x00000800u)
#define PRIV_SLAP			(0x00001000u)
#define PRIV_FREEZE			(0x00002000u)
#define PRIV_SILENCE		(0x00004000u)
#define PRIV_SLAY			(0x00008000u)
#define PRIV_KICK			(0x00010000u)
#define PRIV_BAN			(0x00020000u)
#define	PRIV_REMAP			(0x00040000u)
#define PRIV_WEATHER		(0x00080000u)
#define PRIV_ENTSPAWN		(0x00100000u)
#define PRIV_NPCSPAWN		(0x00200000u)
