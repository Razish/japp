...
// NPC_misc.cpp
//
void Debug_Printf(vmCvar_t *cv, int level, const char *fmt, ...) Q_PRINT_FORMAT(3, 4);
void Debug_NPCPrintf(gentity_t *printNPC, vmCvar_t *cv, int debugLevel, const char *fmt, ...) Q_PRINT_FORMAT(4, 5);
