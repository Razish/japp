...
// NPC_misc.cpp
//
extern void Debug_Printf( vmCvar_t *cv, int level, const char *fmt, ... );
extern void Debug_NPCPrintf( gentity_t *printNPC, vmCvar_t *cv, int debugLevel, const char *fmt, ... );
...
// NPC.cpp
extern void NPC_SetAnim( gentity_t *ent, int type, int anim, uint32_t setAnimFlags );
