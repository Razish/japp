...
XCVAR_DEF(bot_fallbackNoWP, "1", NULL, CVAR_ARCHIVE, qfalse)
...
XCVAR_DEF(g_motd, "", CVU_Motd, CVAR_NONE, qfalse)
...
XCVAR_DEF(g_saberDebugBox, "0", NULL, CVAR_ARCHIVE, qfalse)
XCVAR_DEF(g_saberDebugPrint, "0", NULL, CVAR_ARCHIVE, qfalse)
...
XCVAR_DEF(japp_allowTimeoutDuels, "0", NULL, CVAR_NONE, qtrue)
XCVAR_DEF(japp_allowToggleSpecialAttacks, "0", CVU_ToggleAtk, CVAR_NONE, qtrue)
XCVAR_DEF(japp_allowToggleSaberInSpecial, "1", NULL, CVAR_NONE, qtrue)
...
XCVAR_DEF(japp_duelBow, "0", NULL, CVAR_NONE, qfalse)
XCVAR_DEF(japp_duelRacemode, "0", NULL, CVAR_NONE, qtrue)
...
XCVAR_DEF(japp_fixGetups, "0", NULL, CVAR_ARCHIVE, qtrue)
...
XCVAR_DEF(japp_flipKickDamageDuel, "0", NULL, CVAR_NONE, qtrue)
