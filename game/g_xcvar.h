...
XCVAR_DEF( japp_allowAnyGametype,			"0",					NULL,			CVAR_NONE,										qfalse )
XCVAR_DEF( japp_allowBusyAttack,			"1",					CVU_BusyAttack,	CVAR_NONE,										qtrue )
XCVAR_DEF( japp_allowFallSuicide,			"1",					NULL,			CVAR_NONE,										qfalse )
XCVAR_DEF( japp_allowFlagDrop,				"0",					NULL,			CVAR_NONE,										qtrue )
XCVAR_DEF( japp_allowFlagPull,				"0",					NULL,			CVAR_NONE,										qfalse )
XCVAR_DEF( japp_allowHook,					"0",					NULL,			CVAR_NONE,										qfalse )
...
XCVAR_DEF( japp_fixWeaponCharge,			"1",					NULL,			CVAR_NONE,										qfalse )
XCVAR_DEF( japp_flipKick,					"1",					CVU_Flipkick,	CVAR_NONE,										qtrue )
...
XCVAR_DEF( japp_randFix,					"1",					NULL,			CVAR_NONE,										qfalse )
...
XCVAR_DEF( japp_securityLog,				"1",					NULL,			CVAR_NONE,										qfalse )
XCVAR_DEF( japp_shootFromEye,				"0",					NULL,			CVAR_NONE,										qtrue )
XCVAR_DEF( japp_showLaggingClients,			"1",					NULL,			CVAR_NONE,										qfalse )
XCVAR_DEF( japp_slideOnHead,				"0",					CVU_HeadSlide,	CVAR_NONE,										qtrue )
XCVAR_DEF( japp_spawnWeaps,					"28",					NULL,			CVAR_NONE,										qfalse )
...
XCVAR_DEF( japp_weaponRoll,					"0",					CVU_WeaponRoll,	CVAR_NONE,										qfalse )
XCVAR_DEF( japp_weaponPickupAlways,			"0",					CVU_WeaponPU,	CVAR_NONE,										qfalse )
