...
struct gentity_s {
    ...
    float random;
    int delay;
    int genericValue1, genericValue2, genericValue3, genericValue4, genericValue5, genericValue6, genericValue7, genericValue8, genericValue9, genericValue10,
        genericValue11, genericValue12, genericValue13, genericValue14, genericValue15;
    char *soundSet;
...
typedef struct level_locals_s {
    ...
    int intermissionQueued; // intermission was qualified, but wait INTERMISSION_DELAY_TIME before actually going there so the last frag can be watched. Disable
                            // future kills during this delay
...
int G_CheckAlertEvents(gentity_t *self, qboolean checkSight, qboolean checkSound, float maxSeeDist, float maxHearDist, int ignoreAlert /*= -1*/,
