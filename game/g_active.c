...
static const float maxJediMasterDistance = 6250000.0f; // Replaced the x^2, optimisation
static const float maxJediMasterFOV = 100.0f;
static const float maxForceSightDistance = 3375000000.0f; // Replaced the x^2, optimisation
