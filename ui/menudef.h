...
// this is a hack for stricter typing in UI code
#ifdef __cplusplus
	enum uiTextStyle_e : uint32_t {
		Normal = 0,			// normal text
		Blink,				// fast blinking
		Pulse,				// slow pulsing
		Shadowed,			// drop shadow ( need a color for this )
		Outlined,			// drop shadow ( need a color for this )
		OutlineShadowed,	// drop shadow ( need a color for this )
		ShadowedMore		// drop shadow ( need a color for this )
	};
#else
...
// owner draw types - ideally these should be done outside of this file but this makes it much easier for the macro expansion to convert them for the designers
