...
namespace JPLua{
	...
	static void RefEntity_SetReType(lua_State *L, refEntity_t *ent){
		ent->reType = (refEntityType_t)luaL_checkinteger(L, 3);
	}
	...
	static void RefEntity_SetRenderFx(lua_State *L, refEntity_t *ent){
		ent->renderfx = luaL_checkinteger(L, 3);
	}
	...
	static void RefEntity_SetHModel(lua_State *L, refEntity_t *ent){
		ent->hModel = (qhandle_t)luaL_checkinteger(L, 3);
	}
	...
	static void RefEntity_SetCustomShader(lua_State *L, refEntity_t *ent){
		ent->customShader = (qhandle_t)luaL_checkinteger(L, 3);
	}
	...
	static int RefEntity_GetShaderRGBA(lua_State *L, refEntity_t *ent){
		...
		lua_pushinteger(L, ent->shaderRGBA[0]); lua_settable(L, top);
		lua_pushinteger(L, ent->shaderRGBA[1]); lua_settable(L, top);
		lua_pushinteger(L, ent->shaderRGBA[2]); lua_settable(L, top);
		lua_pushinteger(L, ent->shaderRGBA[3]); lua_settable(L, top);
		return 1;
	} //
	...
	static void RefEntity_SetRadius(lua_State *L, refEntity_t *ent){
	...
	static void RefEntity_SetShadowPlane(lua_State *L, refEntity_t *ent){
		ent->shadowPlane = luaL_checknumber(L, 3);
	}
	...
	static void RefEntity_SetSkinNum(lua_State *L, refEntity_t *ent){
		ent->skinNum = luaL_checkinteger(L, 3);
	...
	static void RefEntity_SetCustomSkin(lua_State *L, refEntity_t *ent){
		ent->customSkin = (qhandle_t)luaL_checkinteger(L, 3);
	}
	...
	static void RefEntity_Line_SetWidth(lua_State *L, refEntity_t *ent){
	...
	static void RefEntity_Line_SetWidth2(lua_State *L, refEntity_t *ent){
		ent->data.line.width2 = luaL_checknumber(L, 3);
	}
	...
	static void RefEntity_Line_SetStScale(lua_State *L, refEntity_t *ent){
		ent->data.line.stscale = luaL_checknumber(L, 3);
	}
	...
	static void RefEntity_SetEndTime(lua_State *L, refEntity_t *ent){
		ent->endTime = luaL_checknumber(L, 3);
	}
	...
	static void RefEntity_SetSaberLength(lua_State *L, refEntity_t *ent){
		ent->saberLength = luaL_checknumber(L, 3);
	}
	...
	static const re_prop_t refEntityProperties[] = {
		...
		{
			"customShader",
			RefEntity_GetCustomShader,
			RefEntity_SetCustomShader
		},
		{
			"customSkin",
			RefEntity_GetCustomSkin,
			RefEntity_SetCustomSkin
		},
		{
			"endTime",
			RefEntity_GetEndTime,
			RefEntity_SetEndTime
		},
		{
			"frame",
			RefEntity_GetFrame,
		...
		{
			"lightOrigin",
			RefEntity_GetLightOrigin,
			RefEntity_SetLightOrigin
		},
		{
			"line_width",
			RefEntity_Line_GetWidth,
			RefEntity_Line_SetWidth
		},
		{
			"line_width2",
			RefEntity_Line_GetWidth2,
			RefEntity_Line_SetWidth2
		},
		{
			"line_stscale",
			RefEntity_Line_GetStScale,
			RefEntity_Line_SetStScale
		},
		{
			"modelScale",
			RefEntity_GetModelScale,
			RefEntity_SetModelScale
		},
		{
			"origin",
			RefEntity_GetOrigin,
		...
		{
			"oldOrigin",
			RefEntity_GetOldOrigin,
			RefEntity_SetOldOrigin
		},
		{
			"radius",
			RefEntity_GetRadius,
		...
		{
			"renderFx",
			RefEntity_GetRenderFx,
			RefEntity_SetRenderFx
		},
		{
			"reType",
			RefEntity_GetReType,
		...
		{
			"saberLength",
			RefEntity_GetSaberLength,
			RefEntity_SetSaberLength
		},
		{
			"shaderRGBA",
			RefEntity_GetShaderRGBA,
			RefEntity_SetShaderRGBA
		},
		{
			"shaderTexCoord",
			RefEntity_GetShaderTexCoord,
			RefEntity_SetShaderTexCoord
		},
		{
			"shadowPlane",
			RefEntity_GetShadowPlane,
			RefEntity_SetShadowPlane
		},
		{
			"skinNum",
			RefEntity_GetSkinNum,
			RefEntity_SetSkinNum
		},
	};
	...
	static int RefEntity_Index(lua_State *L) {
		...
		// assume it's a field
		const re_prop_t *property = (re_prop_t *)bsearch(
			key,
			refEntityProperties,
	...
	static const struct luaL_Reg refentity_meta[] = {
		{ "__index", RefEntity_Index },
		{ "__newindex", RefEntity_NewIndex },
		{ "__eq", RefEntity_Equals },
		{ "__tostring", RefEntity_ToString },
		{ "__gc", RefEntity_Free },
		{ "AddToScene", RefEntity_AddToScene },
		{ "Free", RefEntity_Free },
		{ NULL, NULL }
	};
