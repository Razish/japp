...
//	{ &media.sounds.awards.assist,									NULL,											RFL_NONE,	GTB_CTF },
	...
	{ NULL,															"sound/weapons/saber/saberon.wav",				RFL_NONE,	GTB_ALL },
	{ NULL,															"sound/weapons/saber/saberoffquick.wav",		RFL_NONE,	GTB_ALL },
	{ NULL,															"sound/weapons/saber/saberhitwall1",			RFL_NONE,	GTB_ALL },
	{ NULL,															"sound/weapons/saber/saberhitwall2",			RFL_NONE,	GTB_ALL },
	{ NULL,															"sound/weapons/saber/saberhitwall3",			RFL_NONE,	GTB_ALL },
	{ NULL,															"sound/weapons/saber/saberhit.wav",				RFL_NONE,	GTB_ALL },
	{ NULL,															"sound/weapons/saber/saberhit1.wav",			RFL_NONE,	GTB_ALL },
	{ NULL,															"sound/weapons/saber/saberhit2.wav",			RFL_NONE,	GTB_ALL },
	{ NULL,															"sound/weapons/saber/saberhit3.wav",			RFL_NONE,	GTB_ALL },
	...
	{ NULL,															"sound/weapons/force/lightning",				RFL_NONE,	GTB_ALL },
	...
	{ NULL,															"sound/weapons/force/drain.wav",				RFL_NONE,	GTB_ALL },
...
static const resource_t gfx[] = {
	{ &media.gfx.interface.automap.frameBottom,						"gfx/mp_automap/mpauto_frame_bottom",			RFL_NONE,	GTB_SIEGE },
	{ &media.gfx.interface.automap.frameLeft,						"gfx/mp_automap/mpauto_frame_left",				RFL_NONE,	GTB_SIEGE },
	{ &media.gfx.interface.automap.frameRight,						"gfx/mp_automap/mpauto_frame_right",			RFL_NONE,	GTB_SIEGE },
	{ &media.gfx.interface.automap.frameTop,						"gfx/mp_automap/mpauto_frame_top",				RFL_NONE,	GTB_SIEGE },
	{ &media.gfx.interface.automap.playerIcon,						"gfx/menus/radar/arrow_w",						RFL_NONE,	GTB_SIEGE },
	{ &media.gfx.interface.automap.rocketIcon,						"gfx/menus/radar/rocket",						RFL_NONE,	GTB_SIEGE },
	{ &media.gfx.interface.binoculars.arrow,						"gfx/2d/binSideArrow",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.binoculars.circle,						"gfx/2d/binCircle",								RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.binoculars.mask,							"gfx/2d/binMask",								RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.binoculars.overlay,						"gfx/2d/binocularNumOverlay",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.binoculars.staticMask,					"gfx/2d/binocularWindow",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.binoculars.tri,							"gfx/2d/binTopTri",								RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.disruptor.charge,						"gfx/2d/crop_charge",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.disruptor.insert,						"gfx/2d/cropCircle",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.disruptor.insertTick,					"gfx/2d/insertTick",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.disruptor.light,							"gfx/2d/cropCircleGlow",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.disruptor.mask,							"gfx/2d/cropCircle2",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.medals.assist,							"medal_assist",									RFL_NONE,	GTB_CTF },
	{ &media.gfx.interface.medals.capture,							"medal_capture",								RFL_NONE,	GTB_CTF },
	{ &media.gfx.interface.medals.defend,							"medal_defend",									RFL_NONE,	GTB_CTF },
	{ &media.gfx.interface.medals.excellent,						"medal_excellent",								RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.medals.gauntlet,							"medal_gauntlet",								RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.medals.impressive,						"medal_impressive",								RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.team.assault,							"ui/assets/statusbar/assault",					RFL_NONE,	GTB_ALL&~GTB_NOTTEAM },
	{ &media.gfx.interface.team.blue,								"sprites/team_blue",							RFL_NONE,	GTB_ALL&~GTB_NOTTEAM },
	{ &media.gfx.interface.team.camp,								"ui/assets/statusbar/camp",						RFL_NONE,	GTB_ALL&~GTB_NOTTEAM },
	{ &media.gfx.interface.team.defend,								"ui/assets/statusbar/defend",					RFL_NONE,	GTB_ALL&~GTB_NOTTEAM },
	{ &media.gfx.interface.team.escort,								"ui/assets/statusbar/escort",					RFL_NONE,	GTB_ALL&~GTB_NOTTEAM },
	{ &media.gfx.interface.team.flags[0],							"ui/assets/statusbar/flag_in_base",				RFL_NONE,	GTB_CTF },
	{ &media.gfx.interface.team.flags[1],							"ui/assets/statusbar/flag_capture",				RFL_NONE,	GTB_CTF },
	{ &media.gfx.interface.team.flags[2],							"ui/assets/statusbar/flag_missing",				RFL_NONE,	GTB_CTF },
	{ &media.gfx.interface.team.follow,								"ui/assets/statusbar/follow",					RFL_NONE,	GTB_ALL&~GTB_NOTTEAM },
	{ &media.gfx.interface.team.patrol,								"ui/assets/statusbar/patrol",					RFL_NONE,	GTB_ALL&~GTB_NOTTEAM },
	{ &media.gfx.interface.team.red,								"sprites/team_red",								RFL_NONE,	(GTB_ALL&~GTB_NOTTEAM)|GTB_JEDIMASTER },
	{ &media.gfx.interface.team.retrieve,							"ui/assets/statusbar/retrieve",					RFL_NONE,	GTB_ALL&~GTB_NOTTEAM },
	{ &media.gfx.interface.backTile,								"gfx/2d/backtile",								RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.balloon,									"gfx/mp/chat_icon",								RFL_NONE,	GTB_ALL },
//	{ &media.gfx.interface.charset,									NULL,											RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.chunkyNumbers[0],						"gfx/2d/numbers/c_zero",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.chunkyNumbers[1],						"gfx/2d/numbers/c_one",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.chunkyNumbers[2],						"gfx/2d/numbers/c_two",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.chunkyNumbers[3],						"gfx/2d/numbers/c_three",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.chunkyNumbers[4],						"gfx/2d/numbers/c_four",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.chunkyNumbers[5],						"gfx/2d/numbers/c_five",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.chunkyNumbers[6],						"gfx/2d/numbers/c_six",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.chunkyNumbers[7],						"gfx/2d/numbers/c_seven",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.chunkyNumbers[8],						"gfx/2d/numbers/c_eight",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.chunkyNumbers[9],						"gfx/2d/numbers/c_nine",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.chunkyNumbers[10],						"gfx/2d/numbers/t_minus",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.connection,								"gfx/2d/net",									RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.crosshairs[0],							"gfx/2d/crosshaira",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.crosshairs[1],							"gfx/2d/crosshairb",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.crosshairs[2],							"gfx/2d/crosshairc",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.crosshairs[3],							"gfx/2d/crosshaird",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.crosshairs[4],							"gfx/2d/crosshaire",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.crosshairs[5],							"gfx/2d/crosshairf",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.crosshairs[6],							"gfx/2d/crosshairg",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.crosshairs[7],							"gfx/2d/crosshairh",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.crosshairs[8],							"gfx/2d/crosshairi",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.cursor,									"menu/art/3_cursor2",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.cursorSelect,							"ui/assets/selectcursor",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.cursorSize,								"ui/assets/sizecursor",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.defer,									"gfx/2d/defer",									RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forceCorona,								"gfx/hud/force_swirl",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forceIconBackground,						"gfx/hud/background_f",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_HEAL],				"gfx/mp/f_icon_lt_heal",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_LEVITATION],			"gfx/mp/f_icon_levitation",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_SPEED],				"gfx/mp/f_icon_speed",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_PUSH],				"gfx/mp/f_icon_push",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_PULL],				"gfx/mp/f_icon_pull",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_TELEPATHY],			"gfx/mp/f_icon_lt_telepathy",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_GRIP],				"gfx/mp/f_icon_dk_grip",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_LIGHTNING],			"gfx/mp/f_icon_dk_l1",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_RAGE],				"gfx/mp/f_icon_dk_rage",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_PROTECT],				"gfx/mp/f_icon_lt_protect",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_ABSORB],				"gfx/mp/f_icon_lt_absorb",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_TEAM_HEAL],			"gfx/mp/f_icon_lt_healother",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_TEAM_FORCE],			"gfx/mp/f_icon_dk_forceother",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_DRAIN],				"gfx/mp/f_icon_dk_drain",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_SEE],					"gfx/mp/f_icon_sight",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_SABER_OFFENSE],		"gfx/mp/f_icon_saber_attack",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_SABER_DEFENSE],		"gfx/mp/f_icon_saber_defend",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.forcePowerIcons[FP_SABERTHROW],			"gfx/mp/f_icon_saber_throw",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.hackerIcon,								"gfx/mp/c_icon_tech",							RFL_NONE,	GTB_SIEGE },
	{ &media.gfx.interface.heart,									"ui/assets/statusbar/selectedhealth",			RFL_NONE,	GTB_ALL },
//	{ &media.gfx.interface.invenIcons[HI_NONE],						NULL,											RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.invenIcons[HI_SEEKER],					"gfx/hud/i_icon_seeker",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.invenIcons[HI_SHIELD],					"gfx/hud/i_icon_shieldwall",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.invenIcons[HI_MEDPAC],					"gfx/hud/i_icon_bacta",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.invenIcons[HI_MEDPAC_BIG],				"gfx/hud/i_icon_big_bacta",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.invenIcons[HI_BINOCULARS],				"gfx/hud/i_icon_zoom",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.invenIcons[HI_SENTRY_GUN],				"gfx/hud/i_icon_sentrygun",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.invenIcons[HI_JETPACK],					"gfx/hud/i_icon_jetpack",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.invenIcons[HI_HEALTHDISP],				"gfx/hud/i_icon_healthdisp",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.invenIcons[HI_AMMODISP],					"gfx/hud/i_icon_ammodisp",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.invenIcons[HI_EWEB],						"gfx/hud/i_icon_eweb",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.invenIcons[HI_CLOAK],					"gfx/hud/i_icon_cloak",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.inventoryIconBackground,					"gfx/hud/background_i",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.lagometer,								"gfx/2d/lag",									RFL_NONE,	GTB_ALL },
//	{ &media.gfx.interface.loadBarLED,								NULL,											RFL_NONE,	GTB_ALL },
//	{ &media.gfx.interface.loadBarLEDCap,							NULL,											RFL_NONE,	GTB_ALL },
//	{ &media.gfx.interface.loadBarLEDSurround,						NULL,											RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.numbers[0],								"gfx/2d/numbers/zero",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.numbers[1],								"gfx/2d/numbers/one",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.numbers[2],								"gfx/2d/numbers/two",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.numbers[3],								"gfx/2d/numbers/three",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.numbers[4],								"gfx/2d/numbers/four",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.numbers[5],								"gfx/2d/numbers/five",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.numbers[6],								"gfx/2d/numbers/six",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.numbers[7],								"gfx/2d/numbers/seven",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.numbers[8],								"gfx/2d/numbers/eight",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.numbers[9],								"gfx/2d/numbers/nine",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.numbers[10],								"gfx/2d/numbers/minus",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.pain,									"gfx/misc/borgeyeflare",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.painShields,								"gfx/mp/dmgshader_shields",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.painShieldsAndHealth,					"gfx/mp/dmgshader_shieldsandhealth",			RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.powerduelAlly,							"gfx/mp/pduel_icon_double",						RFL_NOMIP,	GTB_POWERDUEL },
	{ &media.gfx.interface.radar,									"gfx/menus/radar/radar",						RFL_NONE,	GTB_ALL&~GTB_NOTTEAM },
	{ &media.gfx.interface.rageRecovery,							"gfx/mp/f_icon_ragerec",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.scoreboardLine,							"gfx/menus/scoreboard",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.siegeItem,								"gfx/menus/radar/goalitem",						RFL_NONE,	GTB_SIEGE },
	{ &media.gfx.interface.smallNumbers[0],							"gfx/2d/numbers/t_zero",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.smallNumbers[1],							"gfx/2d/numbers/t_one",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.smallNumbers[2],							"gfx/2d/numbers/t_two",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.smallNumbers[3],							"gfx/2d/numbers/t_three",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.smallNumbers[4],							"gfx/2d/numbers/t_four",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.smallNumbers[5],							"gfx/2d/numbers/t_five",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.smallNumbers[6],							"gfx/2d/numbers/t_six",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.smallNumbers[7],							"gfx/2d/numbers/t_seven",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.smallNumbers[8],							"gfx/2d/numbers/t_eight",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.smallNumbers[9],							"gfx/2d/numbers/t_nine",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.smallNumbers[10],						"gfx/2d/numbers/t_minus",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.teamStatusBar,							"gfx/2d/colorbar",								RFL_NONE,	GTB_ALL&~GTB_NOTTEAM },
	{ &media.gfx.interface.vchat,									"gfx/mp/vchat_icon",							RFL_NONE,	GTB_SIEGE },
	{ &media.gfx.interface.weaponIconBackground,					"gfx/hud/background",							RFL_NONE,	GTB_ALL },
//	{ &media.gfx.interface.weaponIcons[WP_NONE],					NULL,											RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_STUN_BATON],				"gfx/hud/w_icon_stunbaton",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_MELEE],					"gfx/hud/w_icon_melee",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_SABER],					"gfx/hud/w_icon_lightsaber",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_BRYAR_PISTOL],			"gfx/hud/w_icon_blaster_pistol",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_BLASTER],					"gfx/hud/w_icon_blaster",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_DISRUPTOR],				"gfx/hud/w_icon_disruptor",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_BOWCASTER],				"gfx/hud/w_icon_bowcaster",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_REPEATER],				"gfx/hud/w_icon_repeater",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_DEMP2],					"gfx/hud/w_icon_demp2",							RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_FLECHETTE],				"gfx/hud/w_icon_flechette",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_ROCKET_LAUNCHER],			"gfx/hud/w_icon_merrsonn",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_THERMAL],					"gfx/hud/w_icon_thermal",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_TRIP_MINE],				"gfx/hud/w_icon_tripmine",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_DET_PACK],				"gfx/hud/w_icon_detpack",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_CONCUSSION],				"gfx/hud/w_icon_c_rifle",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIcons[WP_BRYAR_OLD],				"gfx/hud/w_icon_briar",							RFL_NONE,	GTB_ALL },
//	{ &media.gfx.interface.weaponIcons[WP_EMPLACED_GUN],			NULL,											RFL_NONE,	GTB_ALL },
//	{ &media.gfx.interface.weaponIcons[WP_TURRET],					NULL,											RFL_NONE,	GTB_ALL },
//	{ &media.gfx.interface.weaponIconsInactive[WP_NONE],			"gfx/hud/w_icon_none_na",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_STUN_BATON],		"gfx/hud/w_icon_stunbaton_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_MELEE],			"gfx/hud/w_icon_melee_na",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_SABER],			"gfx/hud/w_icon_lightsaber_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_BRYAR_PISTOL],	"gfx/hud/w_icon_blaster_pistol_na",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_BLASTER],			"gfx/hud/w_icon_blaster_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_DISRUPTOR],		"gfx/hud/w_icon_disruptor_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_BOWCASTER],		"gfx/hud/w_icon_bowcaster_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_REPEATER],		"gfx/hud/w_icon_repeater_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_DEMP2],			"gfx/hud/w_icon_demp2_na",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_FLECHETTE],		"gfx/hud/w_icon_flechette_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_ROCKET_LAUNCHER],	"gfx/hud/w_icon_merrsonn_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_THERMAL],			"gfx/hud/w_icon_thermal_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_TRIP_MINE],		"gfx/hud/w_icon_tripmine_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_DET_PACK],		"gfx/hud/w_icon_detpack_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_CONCUSSION],		"gfx/hud/w_icon_c_rifle_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.interface.weaponIconsInactive[WP_BRYAR_OLD],		"gfx/hud/w_icon_briar_na",						RFL_NONE,	GTB_ALL },
//	{ &media.gfx.interface.weaponIconsInactive[WP_EMPLACED_GUN],	"gfx/hud/w_icon_blaster_na",					RFL_NONE,	GTB_ALL },
//	{ &media.gfx.interface.weaponIconsInactive[WP_TURRET],			"gfx/hud/w_icon_blaster_na",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.footsteps.left.heavy,						"footstep_heavy_l",								RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.footsteps.left.light,						"footstep_l",									RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.footsteps.right.heavy,						"footstep_heavy_r",								RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.footsteps.right.light,						"footstep_r",									RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.red.core,								"gfx/effects/sabers/red_line",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.red.glow,								"gfx/effects/sabers/red_glow",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.orange.core,							"gfx/effects/sabers/orange_line",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.orange.glow,							"gfx/effects/sabers/orange_glow",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.yellow.core,							"gfx/effects/sabers/yellow_line",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.yellow.glow,							"gfx/effects/sabers/yellow_glow",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.green.core,							"gfx/effects/sabers/green_line",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.green.glow,							"gfx/effects/sabers/green_glow",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.blue.core,								"gfx/effects/sabers/blue_line",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.blue.glow,								"gfx/effects/sabers/blue_glow",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.purple.core,							"gfx/effects/sabers/purple_line",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.purple.glow,							"gfx/effects/sabers/purple_glow",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb.core,								"gfx/effects/sabers/RGBcore1",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb.glow,								"gfx/effects/sabers/RGBglow1",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.black.core,							"gfx/effects/sabers/blackcore",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.black.glow,							"gfx/effects/sabers/blackglow",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.black.trail,							"gfx/effects/sabers/blacktrail",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb2.core,								"gfx/effects/sabers/RGBcore2",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb2.glow,								"gfx/effects/sabers/RGBglow2",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb2.trail,							"gfx/effects/sabers/RGBtrail2",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb3.core,								"gfx/effects/sabers/RGBcore3",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb3.glow,								"gfx/effects/sabers/RGBglow3",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb3.trail,							"gfx/effects/sabers/RGBtrail3",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb4.core,								"gfx/effects/sabers/RGBcore4",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb4.glow,								"gfx/effects/sabers/RGBglow4",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb4.trail,							"gfx/effects/sabers/RGBtrail4",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb5.core,								"gfx/effects/sabers/RGBcore5",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb5.glow,								"gfx/effects/sabers/RGBglow5",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.rgb5.trail,							"gfx/effects/sabers/swordTrail",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.sfx.blade,								"gfx/sfx_sabers/saber_blade",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.sfx.blade2,							"gfx/sfx_sabers/saber_blade_rgb",				RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.sfx.end,								"gfx/sfx_sabers/saber_end",						RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.sfx.end2,								"gfx/sfx_sabers/saber_end_rgb",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.sfx.trail,								"gfx/sfx_sabers/saber_trail",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.blur,									"gfx/effects/sabers/saberBlur",					RFL_NONE,	GTB_ALL },
	{ &media.gfx.world.saber.swordTrail,							"gfx/effects/sabers/swordTrail",				RFL_NONE,	GTB_ALL },
	...
	{ &media.gfx.world.glassShard,									"gfx/misc/test_crackle",						RFL_NONE,	GTB_ALL },
	...
	{ &media.gfx.world.shadowMark,									"markShadow",									RFL_NONE,	GTB_ALL },
...
//	{ &media.gfx.world.whiteShader,									NULL,											RFL_NONE,	GTB_ALL },
	...
	{ &media.gfx.world.ysalimari,									"powerups/ysalimarishell",						RFL_NONE,	GTB_CTY },
	...
	{ NULL,															"gfx/effects/forcePush",						RFL_NONE,	GTB_ALL },
...
static const resource_t efx[] = {
	...
	{ &media.efx.tripmine.laser,									"tripMine/laser",								RFL_NONE,	GTB_ALL },
...
static const resource_t models[] = {
	...
	{ NULL,															"models/items/remote.md3",						RFL_NONE,	GTB_ALL },
};
