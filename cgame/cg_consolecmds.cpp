...
static void CG_SizeUp_f(void) { trap->Cvar_Set("cg_viewSize", va("%i", (int)(cg_viewSize.integer + 10))); }

static void CG_SizeDown_f(void) { trap->Cvar_Set("cg_viewSize", va("%i", (int)(cg_viewSize.integer - 10))); }
...
static void CG_TellTarget_f(void) { CG_TellClient(CG_CrosshairPlayer()); }

static void CG_TellAttacker_f(void) { CG_TellClient(CG_LastAttacker()); }
...
static void CG_Menu_f(void) { trap->Key_SetCatcher(trap->Key_GetCatcher() ^ KEYCATCH_CGAME); }

void Cmd_ChatboxSelectTabNext(void) { CG_ChatboxSelectTabNext(); }
void Cmd_ChatboxSelectTabPrev(void) { CG_ChatboxSelectTabPrev(); }
...
void CG_LuaList_f(void) { JPLua::ListPlugins(); }
