...
//	CG_DrawLoadingIcons();
	...
	if ( !atoi( buf ) ) {
		...
		if ( s[0] == '1' ) {
			UI_DrawProportionalString( 320, y, CG_GetStringEdString("MP_INGAME", "PURE_SERVER"), UI_CENTER|UI_INFOFONT|UI_DROPSHADOW, &colorWhite );
			y += iPropHeight;
		}
		...
		{	// display global MOTD at bottom (mirrors ui_main UI_DrawConnectScreen
			...
			if (motdString[0])
				UI_DrawProportionalString( 320, 425, motdString, UI_CENTER|UI_INFOFONT|UI_DROPSHADOW, &colorWhite );
		}
	...
	if ( s[0] == '1' ) {
		UI_DrawProportionalString( 320, y, CG_GetStringEdString("MP_INGAME", "CHEATSAREENABLED"), UI_CENTER|UI_INFOFONT|UI_DROPSHADOW, &colorWhite );
		y += iPropHeight;
	}
	...
	if (cgs.gametype != GT_SIEGE)
	{
		...
		if ( value ) {
			UI_DrawProportionalString( 320, y, va( "%s %i", CG_GetStringEdString("MP_INGAME", "TIMELIMIT"), value ), UI_CENTER|UI_INFOFONT|UI_DROPSHADOW, &colorWhite );
			y += iPropHeight;
		}
		...
		if (cgs.gametype < GT_CTF ) {
			...
			if ( value ) {
				UI_DrawProportionalString( 320, y, va( "%s %i", CG_GetStringEdString("MP_INGAME", "FRAGLIMIT"), value ), UI_CENTER|UI_INFOFONT|UI_DROPSHADOW, &colorWhite );
				y += iPropHeight;
			}
			...
			if (cgs.gametype == GT_DUEL || cgs.gametype == GT_POWERDUEL)
			{
				...
				if ( value ) {
					UI_DrawProportionalString( 320, y, va( "%s %i", CG_GetStringEdString("MP_INGAME", "WINLIMIT"), value ), UI_CENTER|UI_INFOFONT|UI_DROPSHADOW, &colorWhite );
					y += iPropHeight;
				}
			}
		}
	...
	if (cgs.gametype >= GT_CTF) {
		...
		if ( value ) {
			UI_DrawProportionalString( 320, y, va( "%s %i", CG_GetStringEdString("MP_INGAME", "CAPTURELIMIT"), value ), UI_CENTER|UI_INFOFONT|UI_DROPSHADOW, &colorWhite );
			y += iPropHeight;
		}
	}
	...
	if (cgs.gametype >= GT_TEAM)
	{
		...
		if ( value ) {
			UI_DrawProportionalString( 320, y, CG_GetStringEdString("MP_INGAME", "FORCEBASEDTEAMS"), UI_CENTER|UI_INFOFONT|UI_DROPSHADOW, &colorWhite );
			y += iPropHeight;
		}
	}
    ...
    if (cgs.gametype != GT_SIEGE)
	{
		...
		if ( value && !valueNOFP && (value < NUM_FORCE_MASTERY_LEVELS) ) {
			...
			UI_DrawProportionalString( 320, y, va( "%s %s", fmStr, CG_GetStringEdString("MP_INGAME", forceMasteryLevels[value]) ), UI_CENTER|UI_INFOFONT|UI_DROPSHADOW, &colorWhite );
			y += iPropHeight;
		}
		else if ( !valueNOFP )
		{
			...
			UI_DrawProportionalString( 320, y, va( "%s %s", fmStr, (char *)CG_GetStringEdString("MP_INGAME", forceMasteryLevels[7]) ), UI_CENTER|UI_INFOFONT|UI_DROPSHADOW, &colorWhite );
			y += iPropHeight;
		}

		value = atoi( Info_ValueForKey( info, (cgs.gametype == GT_DUEL || cgs.gametype == GT_POWERDUEL) ? "g_duelWeaponDisable" : "g_weaponDisable" ) );
		//RAZTODO: weapon disable

		if ( cgs.gametype != GT_JEDIMASTER && value ) {
			UI_DrawProportionalString( 320, y, va( "%s", (char *)CG_GetStringEdString("MP_INGAME", "SABERONLYSET") ), UI_CENTER|UI_INFOFONT|UI_DROPSHADOW, &colorWhite );
			y += iPropHeight;
		}

		if ( valueNOFP ) {
			UI_DrawProportionalString( 320, y, va( "%s", (char *)CG_GetStringEdString("MP_INGAME", "NOFPSET") ), UI_CENTER|UI_INFOFONT|UI_DROPSHADOW, &colorWhite );
			y += iPropHeight;
		}
	}
