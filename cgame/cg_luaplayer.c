...
static int JPLua_Player_GetAngles( lua_State *L ) {
	...
	lua_pushstring( L, "pitch" );	lua_pushnumber( L, angles.pitch );	lua_settable( L, top );
	lua_pushstring( L, "yaw" );		lua_pushnumber( L, angles.yaw);		lua_settable( L, top );
	lua_pushstring( L, "roll" );	lua_pushnumber( L, angles.roll );	lua_settable( L, top );
