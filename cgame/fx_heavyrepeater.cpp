...
void FX_RepeaterHitWall(vector3 *origin, vector3 *normal) { trap->FX_PlayEffectID(media.efx.repeater.wallImpact, origin, normal, -1, -1, qfalse); }
...
void FX_RepeaterAltHitWall(vector3 *origin, vector3 *normal) { trap->FX_PlayEffectID(media.efx.repeater.altWallImpact, origin, normal, -1, -1, qfalse); }
