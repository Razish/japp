...
typedef struct cgameImport_s {
	...
	void( *R_AddDecalToScene )					(qhandle_t shader, const vector3 *origin, const vector3 *dir, float orientation, float r, float g, float b, float a, qboolean alphaFade, float radius, qboolean temporary);
