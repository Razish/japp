...
#define RF_LIGHTING_ORIGIN                                                                                                                                     \
    (0x00000080u) // use refEntity->lightingOrigin instead of refEntity->origin for lighting. This allows entities to sink into the floor with their origin
                  // going solid, and allows all parts of a player to get the same lighting
